...
const Order = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('https://frozen-headland-36750.herokuapp.com/addOrder', {
            method: 'POST',
            body: formData
        })
                ...
                <div className="col-md-10" >
                    ...
                    <form onSubmit={handleSubmit}
                        ...
                        <div className="form-group">
                            <input type="text"
                                onBlur={handleBlur}
                                class="form-control" name="service" placeholder="SEO" />
                        </div>
                        <div className="form-group">
                            <input type="text"
                                onBlur={handleBlur}
                                className="form-control" name="description" placeholder="Projects Detail" />
                        </div>
                        ...
                        <button style={{ width: '170px', backgroundColor: '#f2b400', color: 'white' }} type="submit" class="btn">Send</button>
                    </form>
                </div>
            </div>
